...
object StarterContent {
    fun items(): List<ContentEntity> = listOf(
        ...
        pill("history-sources", "A primary source needs context", "A document from the period is evidence to interpret, not an automatic guarantee of accuracy.",
            "Ask who created a source, when, for whom, and with what purpose. Compare its account with independent evidence. A diary can reveal an author's perspective while omitting events the author did not observe.",
            "history", "Library of Congress", "https://www.loc.gov/programs/teachers/getting-started-with-primary-sources/",
            "What should you ask when examining a primary source?", listOf("Who created it and why?", "Can its age alone prove every claim?"), 0,
            "Authorship, purpose and context help you interpret evidence."),
        pill("logic-validity", "Validity concerns the connection", "A deductive argument is valid when true premises cannot lead to a false conclusion.",
            "Validity describes the logical relationship between premises and conclusion. A sound argument is valid and has true premises. Check both the reasoning and the evidence for its premises.",
            "philosophy", "Internet Encyclopedia of Philosophy", "https://iep.utm.edu/val-snd/",
            "A sound deductive argument must have…", listOf("A popular conclusion", "Valid reasoning and true premises"), 1,
            "Soundness requires both validity and true premises."),
        pill("literature-voice", "The narrator is a constructed voice", "An author and the narrator of a story are distinct roles.",
            "A narrator presents the story from a particular perspective. First-person narration can limit what a reader knows to what that speaker experiences or chooses to report. Examine language and contradictions before treating the narration as a complete account.",
            "literature", "OpenLearn", "https://www.open.edu/openlearn/history-the-arts/literature/approaching-prose-fiction/content-section-0",
            "Does a first-person narrator necessarily know every character's thoughts?", listOf("Yes", "No"), 1,
            "Narrative perspective limits access to information."),
        pill("economics-opportunity", "Every choice has an alternative", "Opportunity cost is the value of the next-best alternative you give up.",
            "If an hour can be spent studying or working, choosing to study gives up the opportunity to work during that hour. Opportunity cost includes forgone alternatives, not just money paid. Identify the next-best feasible alternative, rather than adding every possible alternative together.",
            "economics", "OpenStax", "https://openstax.org/books/principles-economics-3e/pages/2-1-how-individuals-make-choices-based-on-their-budget-constraint",
            "Opportunity cost refers to…", listOf("Only the cash price", "The next-best alternative forgone"), 1,
            "The relevant comparison is the next-best feasible alternative."),
        pill("engineering-ohms", "Connect voltage, current and resistance", "For an ohmic resistor, voltage equals current times resistance: V = I × R.",
            "For an ohmic resistor at a fixed temperature, potential difference V equals current I multiplied by resistance R. A current of 2 amperes through 6 ohms requires 12 volts. This linear relationship is a model for ohmic components, not every electrical device.",
            "engineering", "OpenStax", "https://openstax.org/books/university-physics-volume-2/pages/9-4-ohms-law",
            "What voltage drives 2 A through a 6 ohm resistor?", listOf("3 V", "12 V", "8 V"), 1,
            "V = I × R = 2 × 6 = 12 volts."),
        pill("certifications-least-privilege", "Grant only the access a task needs", "Least privilege limits permissions to the work a person or service must perform.",
            "A service that only reads reports should not normally receive permission to delete users. Review privileges over time and revoke access that is no longer required. This general security principle supports certification study; it is not an official exam question or a complete certification syllabus.",
            "certifications", "NIST glossary", "https://csrc.nist.gov/glossary/term/least_privilege",
            "Which permission follows least privilege for a report reader?", listOf("Read the necessary reports", "Administer every user account"), 0,
            "Grant permissions needed for the defined task and review them regularly."),
    )
